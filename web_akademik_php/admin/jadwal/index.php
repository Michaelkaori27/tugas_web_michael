    ...
    <table id="list-data" class="display">
        ...
        <?php
            ...
            $sql = "SELECT * from dosen as d
                        ...
                        INNER JOIN jadwal as j ON k.ID_Matkul = me.ID_Matkul AND j.ID_Dosen = <d class="ID_Dosen"
...
<?php
    ...
    //Mata Kuliah
    $sql_dosen = "SELECT * from mata_kuliah";
